...
$summaryPath = "$scriptRoot/backtest_summary.json"
...
$strategies = $strategies | Where-Object { $_ -ne "Momentum" -or $_ -ne "MfiRsiEriTrend" }
...
$summary | ConvertTo-Json -Depth 6 | Set-Content $summaryFullPath
...
Start-Process python3 -ArgumentList "-m http.server 8080" -WorkingDirectory $scriptRoot
Start-Sleep -Seconds 2
Start-Process "xdg-open" "http://localhost:8080/backtest_summary.html"