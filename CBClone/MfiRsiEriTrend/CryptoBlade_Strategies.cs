...
1. ITradingStrategyFactory.cs
2. MfiRsiEriTrendTradingStrategy.cs
3. StrategyNames.cs
4. StrategySelectPreference.cs
5. TradingStrategyBaseOptions.cs
6. TradingStrategyFactory.cs
7. ExecuteParams.cs
8. IndicatorType.cs
9. ITradingStrategy.cs
10. RecursiveStrategyBase.cs
11. RecursiveStrategyBaseOptions.cs
12. ReentryMultiplier.cs
13. StrategyIndicator.cs
14. TimeFrameWindow.cs
15. TradingStrategyBase.cs
16. TradingStrategyCommonBase.cs
17. TradingStrategyCommonBaseOptions.cs
18. Trend.cs
19. BybitErrorCodes.cs
20. ExchangePolicies.cs
21. Balance.cs
22. IWalletManager.cs
23. NullWalletManager.cs
24. WalletManager.cs
25. WalletType.cs
// *******************************
...
// ==== FILE #1: ITradingStrategyFactory.cs ====
...
// ==== FILE #2: MfiRsiEriTrendTradingStrategy.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Exchanges;
...
// ==== FILE #4: StrategySelectPreference.cs ====
namespace CryptoBlade.Strategies
{
...
// ==== FILE #5: TradingStrategyBaseOptions.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Strategies.Common;
...
// ==== FILE #6: TradingStrategyFactory.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Exchanges;
using CryptoBlade.Helpers;
using CryptoBlade.Strategies.Common;
...
// ==== FILE #10: RecursiveStrategyBase.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Helpers;
using CryptoBlade.Strategies.Wallet;
using Microsoft.Extensions.Options;
...
// ==== FILE #11: RecursiveStrategyBaseOptions.cs ====
namespace CryptoBlade.Strategies.Common
{
...
// ==== FILE #15: TradingStrategyBase.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Helpers;
using CryptoBlade.Models;
using CryptoBlade.Strategies.Wallet;
...
// ==== FILE #16: TradingStrategyCommonBase.cs ====
namespace CryptoBlade.Strategies {
using CryptoBlade.Exchanges;
using CryptoBlade.Helpers;
using CryptoBlade.Models;
...
// ==== FILE #17: TradingStrategyCommonBaseOptions.cs ====
namespace CryptoBlade.Strategies.Common
{
